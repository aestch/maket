...
@if(session()->has('loginError'))  
  <div class="alert alert-danger d-flex align-items-center" role="alert">
      <div class="bi bi-exclamation-diamond me-2">
        {{ session('loginError') }}
      </div>
  </div>
@endif
  ...
  <h1 class="h3 mb-3 fw-normal">Login Khusus Kurir</h1>

  <form action="/kurir/login" method="post">
    @csrf
    <div class="form-floating">
      <input type="name" class="form-control @error('nama') is-invalid @enderror" name="nama" id="nama" placeholder="Nama Kamu" autofocus required>
