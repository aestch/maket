...
@endif
  ...
  <form action="/login" method="post">
    ...
    <div class="form-floating">
      <input type="email" class="form-control @error('email') is-invalid @enderror" name="email" id="email" placeholder="Email@example.com" autofocus required>
